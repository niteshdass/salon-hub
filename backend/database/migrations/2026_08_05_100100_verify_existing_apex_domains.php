 ...
 *
 * Scoped to hosts under our own apex, and only those: `<slug>.APP_DOMAIN` is
 * served by a wildcard vhost and a wildcard certificate we control, so there
 * is nothing about it left to verify. A custom domain (v1.2) names a host we
 * do NOT control and must stay unverified until it is checked — this
 * migration deliberately cannot reach one.
 */
